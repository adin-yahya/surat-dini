...
<head>
    ...
    />
    <script src="<?php echo base_url('assets/Sample/') ?>Resources/dynamsoft.webtwain.config.js"></script>
    <script src="<?php echo base_url('assets/Sample/') ?>Resources/dynamsoft.webtwain.initiate.js"></script>
    <script src="<?php echo base_url('assets/Sample/') ?>Resources/addon/dynamsoft.webtwain.addon.pdf.js"></script>
    <link rel="stylesheet" href="<?php echo base_url('assets/Sample/') ?>Style/ds.demo.css">
</head>
...
<body>
            ...
            <div id="headerTop" class="row">
                <div class="ct-lt fl clearfix">
                    <div class="logo mr20 fl">
                        <img src="<?php echo base_url('assets/Sample/') ?>Style/Images/logo-dwt-56x56.png" alt="Logo"> </div>
                    <div class="fl">
                        <div class="linkGroup">
    ...
    <script src="<?php echo base_url('assets/Sample/') ?>Scripts/script.js"></script>
</body>
