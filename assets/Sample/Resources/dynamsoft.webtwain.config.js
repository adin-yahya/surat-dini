...
///
Dynamsoft.DWT.Containers = [{ ContainerId: 'dwtcontrolContainer', Width: '504px', Height: '600px' }];
...
Dynamsoft.DWT.ProductKey = 't00956QAAABcwHsioYTekGwAnEqkI/iNukOnOVsKWprhRBsKig8I/1c9eALV0Hts4X2uu1m4ga0uDINe2kUTuT5orscuUtCBVRYXGvz8Js7sa76ZOozWMyVg6aizuN2JmLs4=';

///
Dynamsoft.DWT.IfHttpPostErrorNoWindow = true;
...
///
//Dynamsoft.DWT.IfCheck64bitServiceFirst = true;
...
/*(function(){
    ...
    if (p !== 'https:' && p !== 'http:')
		Dynamsoft.DWT.ResourcesPath = 'https://demo.dynamsoft.com/DWT/Resources';
	else
